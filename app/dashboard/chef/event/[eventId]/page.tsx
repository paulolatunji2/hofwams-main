...
import { CreateMealPlanDialog } from "@/components/chef/create-meal-plan-dialog";
...
const EventDetailsPage = async ({
  ...
  const ingredientInventory = await getAllIngredientInventories();
  ...
  return (
    ...
    >
      ...
      {user.chefType === ChefType.EXECUTIVE_CHEF && (
        <div className="flex justify-end">
          <CreateMealPlanDialog
            mealName={eventInfo.data?.meals ?? []}
            chefs={chefIds}
            ingredientInventory={ingredientInventory.data ?? []}
